...
let param = qs.stringify({
	...
	appid:'wx208338c0b9ac750f',
	secret:'d59f9e0154884b397b2b5c9eeb301ce0'
})
...
// 云环境id
let env = 'kecheng-diancan-7gtw3y7s4cb1f4e5'
...
class getToken{
	...
	async subscribe(touser,data){
		try{
			let token = await this.gettoken()
			let OBJ = {touser,data,template_id:'rgh-k9AinK2oikp4Q9iqcgMND0BkqiVOSQLNGKoZ-js',page:'pages/my-order/my-order',miniprogram_state:'developer'}
